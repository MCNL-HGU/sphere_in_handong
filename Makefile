...
video: video_test.cpp
	g++ -std=c++17 -o video_test video_test.cpp packet_sender/e131_sender.cpp image_processor/image_processor.cpp -L/path/to/e131/lib -le131 $(pkg-config --cflags --libs opencv4) -ljsoncpp
